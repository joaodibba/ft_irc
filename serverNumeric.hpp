...
#define NOTICE_MSG(massage) (string(":localhost NOTICE * :") + (message) + "\r\n")
...
#define ERR_NOTNCHANNEL(nick, channelName)(ERR_SAMPLE_2("422", "You're not on that channel", nick, channelName))
