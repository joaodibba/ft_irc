...
//}
//
//void Irc::setNonBlockin(int *ptr) {
...
//
//	setNonBlockin(&newSock);
//	epfds->addFd(newSock, EPOLLIN | EPOLLERR | EPOLLHUP);
//	_clients.insert(make_pair(newSock, (new Client(newSock))));
//	cout << MAGENTA "Opening connection, fd; " << new Sock << END << endl;
//}

//void Irc::intNetwork(void)
//{
//	struct sockaddr_in address;
...
//
//	_serverSoch = socket(AF_INET, SOCK_STREAM, 0);
//	if (_serverSock == -1)
//		throw runtime_error("Failed to create socket");
//
//	epfds = new EpollManager();
//	epfds->addFd(_severSock, EPOLLIN | EPOLLET);
//
//	int enable = 1;
//	setNonBlockin(&_serverSock);
...
//	if (bind(_servSock, (struct sockaddr *)&address, addrlen) < 0)
